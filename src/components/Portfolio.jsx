...
const projectData = [
  ...
  },
  {
    ...
    link: null,
    github:
      "https://github.com/ahsaniqbal0077-cloud/MiniDistributedCache",
  },
  {
    image:
    ...
    link: null,
    github: "https://github.com/ahsaniqbal0077-cloud/My-portfolio",
  },
];

const Portfolio = () => {
  // Explicit GitHub redirect
  ...
  return (
    <section
      id="projects"
      className="bg-[#020202] py-24 px-6 md:px-12 lg:px-24"
    >
        ...
        {projectData.map((project, index) => (
          ...
          >
            ...
            <div className="p-8 relative z-50">
              <h3 className="text-2xl font-black text-white mb-4 tracking-tight uppercase pointer-events-none">
                {project.title}
              </h3>
              ...
              <div className="flex flex-wrap gap-2 mb-8 pointer-events-none">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-[9px] uppercase tracking-widest font-mono px-3 py-1 bg-white/10 text-blue-300 rounded-full"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex gap-4 relative z-[100]">
                ...
                <button
                  ...
                  className="inline-flex p-3 bg-white/5 text-white rounded-xl hover:bg-blue-600 transition-all border border-white/10 relative z-[100] pointer-events-auto cursor-pointer"
                >
                  <FiGithub size={20} />
                </button>
